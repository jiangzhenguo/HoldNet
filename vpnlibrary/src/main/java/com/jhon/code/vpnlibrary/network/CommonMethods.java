package com.jhon.code.vpnlibrary.network;
...
/**
 * Created by jzg on 15/12/28.
 */
public class CommonMethods {

	static String TAG = CommonMethods.class.getName();
	...
	public static InetAddress ipIntToInet4Address(int ip) {
		...
		try {
			...
			Log.e(TAG,"IP int to InetAddress parse error!");
			return null;
		}
	}
